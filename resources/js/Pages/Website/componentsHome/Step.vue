    ...
    <section class="py-12 bg-gray-50 sm:py-16 lg:py-20 dark:bg-gray-900">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto text-center">
                <p class="text-lg font-medium text-blue-600 dark:text-blue-400 font-pj">
            ...
            <div
                ...
                <div
                    ...
                    <p class="mt-4 text-base leading-7 text-gray-600 font-pj dark:text-gray-300">
                        Création de votre site avec les dernières technologies. Design moderne et responsive.
                    </p>
                    ...
                    <ul class="mt-6 space-y-2 text-gray-600 dark:text-gray-400">
                        <li class="flex items-center">
                            <i class='bx bx-check-circle text-green-500 dark:text-green-400 mr-2'></i>
                            <span>Développement en 24h</span>
                        </li>
                        <li class="flex items-center">
                            <i class='bx bx-check-circle text-green-500 dark:text-green-400 mr-2'></i>
                ...
                <div
                    ...
                    <p class="mt-4 text-base leading-7 text-gray-600 font-pj dark:text-gray-300">
                        Mise en ligne de votre site et formation à son utilisation. Support technique inclus.
                    </p>
