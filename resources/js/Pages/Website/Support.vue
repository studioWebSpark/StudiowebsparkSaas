                    ...
                    <div class="flex items-center justify-between h-16">
                        ...
                        <div class="flex items-center justify-end ml-auto space-x-6">
                            ...
                            <button type="button"
                                ...
                                <img class="object-cover bg-gray-300 rounded-full w-9 h-9"
                    ...
                    <div class="flex flex-col pt-5 overflow-y-auto">
                        <div class="flex flex-col justify-between flex-1 h-full px-4">
                            <div class="space-y-4">
                                ...
                                <div>
                                    <p class="px-4 text-xs font-semibold tracking-widest text-gray-400 uppercase">Shop
                                    </p>
                                    <nav class="flex-1 mt-4 space-y-1">
                                        <a href="#" title=""
                                            class="flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 text-gray-900 rounded-lg hover:bg-gray-200 group">
                        ...
                        <div class="py-6">
                            <div class="px-4 mx-auto sm:px-6 md:px-8">
                                <div class="md:items-center md:flex">
                                    <p class="text-base font-bold text-gray-900">Hey Mariana -</p>
                                    <p class="mt-1 text-base font-medium text-gray-500 md:mt-0 md:ml-2">here's what's
                            ...
                            <div class="px-4 mx-auto mt-8 sm:px-6 md:px-8">
                                <div class="space-y-5 sm:space-y-6">
                                            ...
                                            <div class="px-5 py-4">
                                                ...
                                                <div class="flex items-center justify-between mt-3">
                                                    ...
                                                    <span
                                                        ...
                                                        + 36%
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 ml-0.5"
                                        ...
                                        <div class="bg-white border border-gray-200 rounded-xl">
                                            <div class="px-5 py-4">
                                                ...
                                                <div class="flex items-center justify-between mt-3">
                                                    ...
                                                    <span
                                                        class="inline-flex items-center text-sm font-semibold text-red-500">
                                                        - 14%
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 ml-0.5"
                                                            fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                                            stroke-width="3">
                                    ...
                                    <div class="grid grid-cols-1 gap-5 sm:gap-6 lg:grid-cols-6">
                                        <div
                                            class="overflow-hidden bg-white border border-gray-200 rounded-xl lg:col-span-4">
                                            <div class="px-4 pt-5 sm:px-6">
                                                <div class="flex flex-wrap items-center justify-between">
                                                    <p class="text-base font-bold text-gray-900 lg:order-1">Sales Report
                                                    </p>
                                                    ...
                                                    <nav
                                                        ...
                                                        <a href="#" title=""
                                                            class="px-2 py-2 text-xs font-bold text-gray-900 transition-all border border-gray-900 rounded-lg sm:px-4 hover:bg-gray-100 dration-200">
                                                            12 Months </a>

                                                        <a href="#" title=""
                                                            class="px-2 py-2 text-xs font-bold text-gray-500 transition-all border border-transparent rounded-lg sm:px-4 hover:bg-gray-100 dration-200">
                                                            6 Months </a>
                                        ...
                                        <div
                                            class="overflow-hidden bg-white border border-gray-200 rounded-xl lg:col-span-2">
                                            <div class="px-4 py-5 sm:p-6">
                                                ...
                                                <div class="mt-8 space-y-6">
                                                    ...
                                                    <div>
                                                        <div class="flex items-center justify-between">
                                                            <p class="text-sm font-medium text-gray-900">Social Media
                                                            </p>
                                        ...
                                        <div
                                            ...
                                            <div class="px-4 py-5 sm:p-6">
                                                <div class="sm:flex sm:items-start sm:justify-between">
                                                    <div>
                                                        ...
                                                        <p class="mt-1 text-sm font-medium text-gray-500">Lorem ipsum
                                            ...
                                            <div class="divide-y divide-gray-200">
                                                <div class="grid grid-cols-3 py-4 gap-y-4 lg:gap-0 lg:grid-cols-6">
                                                    <div class="col-span-2 px-4 lg:py-4 sm:px-6 lg:col-span-1">
                                                        <span
                                                            ...
                                                            <svg class="-ml-1 mr-1.5 h-2.5 w-2.5 text-green-500"
                                                    ...
                                                    <div class="px-4 lg:py-4 sm:px-6 lg:col-span-2">
                                                        <p class="text-sm font-bold text-gray-900">Visa card **** 4831
                                                        </p>
                                                        <p class="mt-1 text-sm font-medium text-gray-500">Card payment
                                                        </p>
                                                    </div>

                                                    <div class="px-4 lg:py-4 sm:px-6">
                                                        <p class="text-sm font-bold text-gray-900">$182.94</p>
                                                        <p class="mt-1 text-sm font-medium text-gray-500">Jan 17, 2022
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="grid grid-cols-3 py-4 gap-y-4 lg:gap-0 lg:grid-cols-6">
                                                    ...
                                                    <div class="px-4 lg:py-4 sm:px-6 lg:col-span-2">
                                                        <p class="text-sm font-bold text-gray-900">Mastercard **** 6442
                                                        </p>
                                                        <p class="mt-1 text-sm font-medium text-gray-500">Card payment
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="grid grid-cols-3 py-4 gap-y-4 lg:gap-0 lg:grid-cols-6">
                                                    <div class="col-span-2 px-4 lg:py-4 sm:px-6 lg:col-span-1">
                                                        <span
                                                            class="text-xs font-medium text-yellow-900 bg-yellow-100 rounded-full inline-flex items-center px-2.5 py-1">
                                                            <svg class="-ml-1 mr-1.5 h-2.5 w-2.5 text-yellow-400"
                                                                fill="currentColor" viewBox="0 0 8 8">
                                                                <circle cx="4" cy="4" r="3"></circle>
                                                            </svg>
                                                            Pending
                                                    ...
                                                    <div class="px-4 lg:py-4 sm:px-6 lg:col-span-2">
                                                        ...
                                                        <p class="mt-1 text-sm font-medium text-gray-500">Bank payment
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="grid grid-cols-3 py-4 gap-y-4 lg:gap-0 lg:grid-cols-6">
                                                    <div class="col-span-2 px-4 lg:py-4 sm:px-6 lg:col-span-1">
                                                        <span
                                                            class="text-xs font-medium text-red-900 bg-red-100 rounded-full inline-flex items-center px-2.5 py-1">
                                                            <svg class="-ml-1 mr-1.5 h-2.5 w-2.5 text-red-500"
                                                                fill="currentColor" viewBox="0 0 8 8">
                                                                <circle cx="4" cy="4" r="3"></circle>
                                                            </svg>
                                                            Canceled
                                                    ...
                                                    <div class="px-4 lg:py-4 sm:px-6 lg:col-span-2">
                                                        <p class="text-sm font-bold text-gray-900">Amex card **** 5666
                                                        </p>
                                                        <p class="mt-1 text-sm font-medium text-gray-500">Card payment
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="px-4 lg:py-4 sm:px-6">
                                                        <p class="mt-1 text-sm font-medium text-gray-500">Amazon Prime
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <div class="px-4 py-5 sm:p-6">
                                                <div>
                                                    ...
                                                    <p class="mt-1 text-sm font-medium text-gray-500">Lorem ipsum dolor
                                                        sit ametis.</p>
                                                </div>
                                                    ...
                                                    <div class="flex items-center justify-between space-x-5">
                                                        <div class="flex items-center flex-1 min-w-0">
                                                            ...
                                                            <div class="flex-1 min-w-0 ml-4">
                                                                <p class="text-sm font-bold text-gray-900">Jenny Wilson
                                                                </p>
                                                                <p class="mt-1 text-sm font-medium text-gray-500">
                                                                    w.lawson@example.com</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="flex items-center justify-between space-x-5">
                                                        <div class="flex items-center flex-1 min-w-0">
                                                            <img class="flex-shrink-0 object-cover w-10 h-10 rounded-full"
                                                                ...
                                                                alt="" />
                                                            <div class="flex-1 min-w-0 ml-4">
                                                                <p class="text-sm font-bold text-gray-900">Devon Lane
                                                                </p>
                                                                <p
                                                                    class="mt-1 text-sm font-medium text-gray-500 truncate">
                                                                    dat.roberts@example.com</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="flex items-center justify-between space-x-5">
                                                        <div class="flex items-center flex-1 min-w-0">
                                                            <img class="flex-shrink-0 object-cover w-10 h-10 rounded-full"
                                                                ...
                                                                alt="" />
                                                            <div class="flex-1 min-w-0 ml-4">
                                                                <p class="text-sm font-bold text-gray-900">Jane Cooper
                                                                </p>
                                                                <p
                                                                    class="mt-1 text-sm font-medium text-gray-500 truncate">
                                                                    jgraham@example.com</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="flex items-center justify-between space-x-5">
                                                        <div class="flex items-center flex-1 min-w-0">
                                                            <img class="flex-shrink-0 object-cover w-10 h-10 rounded-full"
                                                                ...
                                                                alt="" />
                                                            <div class="flex-1 min-w-0 ml-4">
                                                                <p class="text-sm font-bold text-gray-900">Dianne
                                                                    Russell</p>
                                                                <p
                                                                    class="mt-1 text-sm font-medium text-gray-500 truncate">
                                                                    curtis.d@example.com</p>
                                                            </div>
                                                        </div>

                                                        <div class="text-right">
                                                            <p class="text-sm font-medium text-gray-900">$9,084</p>
                                                            <p class="mt-1 text-sm font-medium text-gray-500">Naperville
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
