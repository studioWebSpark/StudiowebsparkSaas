...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
          Veuillez vérifier votre adresse e-mail en cliquant sur le lien que nous avons envoyé à votre adresse e-mail. Si vous n'avez pas reçu l'e-mail, nous vous en enverrons un autre.
        </div>
